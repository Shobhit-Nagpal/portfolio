...
const Projects = () => {
    ...
    useEffect(() => {
        setProjects([{name: 'Palette Pix', description: 'A tool where designers and developers can quickly test out color palettes. Users can change to palettes of their choice or get a random palette.', img: palettePixImg, website: 'https://shobhit-nagpal.github.io/palettepix/', repo: 'https://github.com/Shobhit-Nagpal/palettepix'}, 
                     ...
                     {name: 'JS-Lexer', description: 'JS-Lexer is a project inspired from making a Monkey interpreter in Go by reading "Writing an Interpreter in Go" by Thorsten Ball. The goal was simply to build the lexer out on my own in JS. Published as an npm package.', img: jsLexerImg, website: 'https://www.npmjs.com/package/@shobhit-nagpal/js-lexer', repo: 'https://github.com/Shobhit-Nagpal/js-lexer'},
